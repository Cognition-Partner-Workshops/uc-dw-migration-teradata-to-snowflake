...
-- Original Teradata PI: PRIMARY INDEX PI_MONTHLY_SNAP (ACCOUNT_KEY, SNAPSHOT_MONTH_KEY)
-- Original Teradata PPI: PARTITION BY RANGE_N(SNAPSHOT_DATE ... EACH INTERVAL 1 MONTH)
