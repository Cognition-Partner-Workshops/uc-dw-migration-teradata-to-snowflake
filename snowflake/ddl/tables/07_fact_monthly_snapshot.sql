 ...
 * - Replaced: PI composite -> CLUSTER BY
 * - Replaced: PPI PARTITION BY RANGE_N -> CLUSTER BY
 * - Removed: COLLECT STATISTICS
 **********************************************************************/

CREATE TABLE BANKING_DW.FACT_MONTHLY_ACCOUNT_SNAPSHOT
(
...
-- Clustering on SNAPSHOT_DATE and ACCOUNT_KEY replaces the Teradata PPI for partition elimination.
