 ...
 *
 * Identifies transactions above reporting thresholds.
 ...
 * - HASHROW(col1, col2)  ->  HASH(col1, col2)
 * - QUALIFY kept (Snowflake supports natively)
 **********************************************************************/

CREATE OR REPLACE VIEW BANKING_DW.VW_REGULATORY_LARGE_TRANSACTIONS
    COMMENT = 'Regulatory reporting: transactions exceeding NOK thresholds or flagged as suspicious'
AS
SELECT
    ft.TRANSACTION_ID,
    ft.TRANSACTION_DATE,
